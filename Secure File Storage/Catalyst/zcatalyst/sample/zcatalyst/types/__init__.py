...
class ICatalystSignupConfig(TypedDict):
    zaid: str
    platform_type: str
...
class ICatalystUserDetails(TypedDict):
...
class ICatalystPushDetails(TypedDict):
    message: str
...
class ICatalystSearchQuery(TypedDict):
    search: str
